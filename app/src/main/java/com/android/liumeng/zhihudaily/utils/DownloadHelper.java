...
public class DownloadHelper implements Serializable {
	 ...
	 *            本地存放地址
	 */
	public DownloadHelper(int downloadId, String url, String localDir) {
	 ...
	 * @return this
	 */
	public DownloadHelper setOnDownloadListener(OnDownloadListener listener) {
		mListener = listener;
		return this;
	}
	...
	private static HttpParams getHttpParams() {
		...
		HttpProtocolParams.setUserAgent(params, "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/37.0.2041.4 Safari/537.36");
	...
	public boolean downloadFileExist(File file, String mFileName) {
		...
		if (file.exists()) {
			...
			String path = file.getAbsolutePath() + File.separator + mFileName;
			if (FileUtils.getFileSize(path) <= 10) {
